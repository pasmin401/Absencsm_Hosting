...
<title><?= $step === 'reset' ? 'Reset Password' : 'Forgot Password' ?> – <?= e(APP_NAME) ?></title>
...
<div class="auth-wrapper">
  <div class="auth-brand">
    ...
    <p><?= $step === 'reset' ? 'Create a strong new password to secure your account.' : 'Enter your registered email and we\'ll send you a reset link.' ?></p>
  ...
  <div class="auth-form-side">
    <div class="auth-form-container">
      ...
      <?php if ($step === 'expired'): ?>
        ...
        <a href="forgot-password.php" class="btn btn-primary btn-full btn-lg">Request New Link</a>
        ...
        <form method="POST" novalidate>
          <div class="form-group">
            ...
            <div class="input-wrap">
              <input type="password" id="password" name="password" class="has-icon" placeholder="Min. 6 characters" required>
          ...
          <div class="form-group">
            ...
            <div class="input-wrap">
              <input type="password" id="confirm" name="confirm" class="has-icon" placeholder="Repeat password" required>
      ...
      <?php else: ?>
        ...
        <form method="POST" novalidate>
          <div class="form-group">
            ...
            <input type="email" id="email" name="email" value="<?= e($_POST['email'] ?? '') ?>" placeholder="you@email.com" required>
          </div>
