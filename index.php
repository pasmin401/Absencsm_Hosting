...
if (isLoggedIn() && !isset($_GET['msg'])) {
    $dest = isAdmin() ? 'admin/index.php' : 'dashboard.php';
...
<div class="auth-wrapper">
  ...
  <div class="auth-brand">
    ...
    <div class="auth-features">
      <div class="auth-feature-item"><span>📍</span><span>GPS-verified location tracking</span></div>
      <div class="auth-feature-item"><span>📸</span><span>Photo proof at every check-in</span></div>
      <div class="auth-feature-item"><span>⏱️</span><span>Overtime monitoring & records</span></div>
      <div class="auth-feature-item"><span>📊</span><span>Instant Excel reports export</span></div>
    </div>
  </div>
